...
int main(void)
{
	...
	/*
	- ตัวแปร ref_latitude และ ref_longitude จะได้ค่าพิกัดที่เป็นตัวเลขทศนิยม
	- ในลูป main ของคุณ (ช่วงที่เรียกฟังก์ชัน print_distance_from_reference)
	  จะสามารถนำตัวเลขเหล่านี้ไปคำนวณหาความต่างกับพิกัดที่ได้จากดาวเทียมได้ทันทีครับ
	*/
	...
	// k_uptime_get() returns the system uptime in milliseconds.
	fix_timestamp = k_uptime_get();
